...
for i in range(1,100):
    ...
    if int(chislo,2)>40:
        ...
        break
Условия: Найти минимальное число, которое после перехода в 2-ичную сс преобразуется по правилу: если ч. чётное, то вместо последних 2 символов дописывается 110, нечётное - 001. Получившееся значение д.б >160 
   ```
   ```
#6
Алгоритм:
